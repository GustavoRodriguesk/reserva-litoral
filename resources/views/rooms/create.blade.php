<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-bold text-2xl text-gray-800 leading-tight">Novo Quarto</h2>
                <p class="text-sm text-gray-500 mt-1">Adicione um novo quarto ao inventário</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                <div class="p-6 border-b border-slate-50">
                    <h3 class="font-bold text-slate-800">Informações do Quarto</h3>
                </div>
